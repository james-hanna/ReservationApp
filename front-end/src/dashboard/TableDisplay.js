  ...
  return (
    <div>
      <ul className="tables_list p-0">
        ...
        {tables.map((table, index) => table.reservation_id ? (
          <li key={table.table_id} className="table-list-item">
            <div
              className="card"
              style={{ backgroundColor: "lightpink", border: "solid 1px red", marginBottom: "15px" }}
            >
          ...
          <li key={table.table_id} className="table-list-item">
            <div
              className="card"
              style={{ backgroundColor: "lightgreen", border: "solid 1px green", marginBottom: "15px" }}
            >
              <div className="card-body">
                <h5>Table {table.table_id}:</h5>
                <div>Name: {table.table_name}</div>
